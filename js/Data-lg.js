(function(){
  ...
  const bands = [
    ...
    { key:'bass',    label:'Bass',     freq:80,  type:'peaking',  color:'--band-bass',   Q:3},
  ...
  function initAudio(){
    ...
    lowMidF.type = 'peaking'; lowMidF.frequency.value = 400; lowMidF.Q.value = 1; lowMidF.gain.value = 2;

    midF = actx.createBiquadFilter();
    midF.type = 'peaking'; midF.frequency.value = 1000; midF.Q.value = 1; midF.gain.value = 3;

    highMidF = actx.createBiquadFilter();
    highMidF.type = 'peaking'; highMidF.frequency.value = 2500; highMidF.Q.value = 1; highMidF.gain.value = 2;

    trebleF = actx.createBiquadFilter();
    trebleF.type = 'peaking'; trebleF.frequency.value = 6000; trebleF.Q.value = 1; trebleF.gain.value = 2;
  ...
  function applyAllBands(){
    ...
    const tracks = [    
      ...
      artist:"wuxia", 
      genre:"gamagus", 
      url:"https://archive.org/download/a-1gemagus-x-adtuying-imam/Gemagus%28imam%29.mp3" },    
      { title:"Gemagus", 
      artist:"gemagus", 
      genre:"gemagus",  url:"https://archive.org/download/a-1gemagus-x-adtuying-imam/A1gemagus%20x%20ad%2Ctuying%20%28imam%29.mp3" },   
      { title:"Rain", 
      artist:"alam",
      genre:"alam hujan",  url:"https://archive.org/download/udan-di-desa/hujan%20gerimis%20suara%20katak%20dan%20jangkrik%20suasana%20desa%20dijamin%20langsung%20tidur%20-%20Dunia%20Relaksasi.mp3" },   
      { title:"Rain",   
      artist:"alam", 
      genre:"alam hujan",  url:"https://archive.org/download/raingueudan/rain%28gueudan%29.mp3" },    
      { title:"flute",   
      artist:"cover wuxia", 
      genre:"alam 3",  url:"https://archive.org/download/iringan-2/Iringan2.mp3" },  
      { title:"hujan buat tidur",  
      artist:"alam",
      genre:"alam hujan3",  url:"https://archive.org/download/mashugemagusudan/mashugemagus%28udan%29%20.mp3" }, 
     { title:"sore hari",  
      artist:"gemagus", 
      genre:"cover wuxia",  url:"https://archive.org/download/ket-3enanganmashub/Ket3enangan%28mashub%29.mp3" },    
      { title:"berbicara dalam diam", 
      artist:"gemagus",
      genre:"movie",  url:"https://archive.org/download/a-2-pendekar-3-x-adtuying-mashup/A2%20-%20pendekar3%20x%20ad%2Ctuying%20%28Mashup%29.mp3" },  
      { title:"sound cek",  
      artist:"MHLS",
