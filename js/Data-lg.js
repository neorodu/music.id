(function(){
  ...
  function applyAllBands(){
    ...
    /* ============ DATA LAGU ============     baca zipmsir.  ================================== */  const tracks = [    { title:"cover wuxia",   artist:"wuxia", genre:"gamagus",  url:"https://archive.org/download/a-1gemagus-x-adtuying-imam/Gemagus%28imam%29.mp3" },    { title:"Gemagus", artist:"gemagus", genre:"gemagus",  url:"https://archive.org/download/a-1gemagus-x-adtuying-imam/A1gemagus%20x%20ad%2Ctuying%20%28imam%29.mp3" },    { title:"Rain",    artist:"alam", genre:"alam hujan",  url:"https://archive.org/download/udan-di-desa/hujan%20gerimis%20suara%20katak%20dan%20jangkrik%20suasana%20desa%20dijamin%20langsung%20tidur%20-%20Dunia%20Relaksasi.mp3" },     { title:"Rain",    artist:"alam", genre:"alam hujan",  url:"https://archive.org/download/raingueudan/rain%28gueudan%29.mp3" },     { title:"flute",    artist:"cover wuxia", genre:"alam 3",  url:"https://archive.org/download/iringan-2/Iringan2.mp3" },     { title:"hujan buat tidur",    artist:"alam", genre:"alam hujan3",  url:"https://archive.org/download/mashugemagusudan/mashugemagus%28udan%29%20.mp3" },     { title:"cinematic",    artist:"movie", genre:"sound",  url:"https://archive.org/download/whispers-over-the-water-1/Whispers%20Over%20The%20Water%20(1).mp3" },     { title:"berbicara dalam diam",    artist:"gemagus", genre:"movie",  url:"https://archive.org/download/a-2-pendekar-3-x-adtuying-mashup/A2%20-%20pendekar3%20x%20ad%2Ctuying%20%28Mashup%29.mp3" },     { title:"sound movie",    artist:"alam", genre:"epic",  url:"https://archive.org/download/whispers-over-the-water-1/Whispers%20Over%20The%20Water%20(1).mp3" }  ];
  let currentTrack = 0;
  let isPlaying = false;
  let shuffleOn = false;
